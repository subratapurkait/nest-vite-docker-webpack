...
export const UserManagement = () => {
  ...
  <h2 id="user-management-page-heading" data-cy="userManagementPageHeading">
    ...
    <div className="flex justify-end">
      ...
      <Link to="new" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded jh-create-entity">
  ...
  <Table responsive striped>
    <thead>
      <tr>
        ...
        <th className="cursor-pointer" onClick={sort('createdDate')}>
          <Translate contentKey="userManagement.createdDate">Created Date</Translate>{' '}
          <FontAwesomeIcon icon={getSortIconByFieldName('createdDate')} />
        </th>
        <th className="cursor-pointer" onClick={sort('lastModifiedBy')}>
          <Translate contentKey="userManagement.lastModifiedBy">Last Modified By</Translate>{' '}
          <FontAwesomeIcon icon={getSortIconByFieldName('lastModifiedBy')} />
        </th>
        <th id="modified-date-sort" className="cursor-pointer" onClick={sort('lastModifiedDate')}>
